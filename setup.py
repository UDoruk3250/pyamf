...
LONG_DESCRIPTION = 'Absolute Molecule File library extension for python. Absolute Molecule File (*.amf) is a ' \
                   'specific kind of a filetype that allows people to create molecules and proteins easily.'
